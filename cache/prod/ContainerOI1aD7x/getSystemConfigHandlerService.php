...
class getSystemConfigHandlerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 4)), ($container->privates['App\\Currency\\LegacyHandler\\CurrencyHandler'] ?? $container->load('getCurrencyHandlerService')), ($container->privates['App\\Install\\LegacyHandler\\InstallHandler'] ?? $container->load('getInstallHandlerService')), $container->parameters['legacy.system_config_key_map'], $container->parameters['legacy.cache_reset_actions'], $container->parameters['legacy.module_routing'], $container->parameters['themes.navigation_tab_limits'], $container->parameters['module.listview.column_limits'], $container->parameters['module.listview.settings_limits'], $container->parameters['module.listview.actions_limits'], $container->parameters['module.recordview.actions_limits'], $container->parameters['module.listview.line_actions_limits'], $container->parameters['ui'], [], $b);
    }
}
